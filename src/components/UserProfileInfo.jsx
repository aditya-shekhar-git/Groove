        ...
        <div className='flex flex-col items-start md:flex-row gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between'>
                    ...
                    {!profileId && // we will open users own id and provide edit option
                ...
                <div className='flex items-center gap-6 mt-6 border-t border-e-gray-200 pt-4'>
                    <div className='sm:text-xl font-bold text-gray-900'>
